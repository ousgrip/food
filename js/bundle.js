...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({conteiner, nextArrow, prevArrow, slide, totalCounter, currentCounter, wrapper,field}) {
    // slider
    ...
    if (slides.length < 10) {
        total.textContent = `o${slides.length}`;
        current.textContent = `o${slideIndex}`;
    } else {
    ...
    indicators.classList.add('carousel-indiators');
